...
<div class="timeline-row"><p class="timeline-date">2024–2026</p><div class="experience"><img class="experience-logo houmoon-logo" src="/images/houmoon-logo.png" alt="Houmoon logo" width="1254" height="1254" loading="lazy"><div><h3>{link(url('projects',houmoon),'Houmoon Ltd.')}</h3><p>Founder of an AI wellbeing start-up. About 100 internal testers; dissolved in May 2026 before any public release.</p></div></div></div>
...
<div class="timeline-row"><p class="timeline-date">2019–2020</p><div><h3>INTO Newcastle University</h3><p>International Foundation Year in mathematics, computing and academic English; top 5% of the cohort.</p></div></div>
...
<div class="cv-item"><span>2019–2020</span><div><h3>INTO Newcastle University</h3><p>International Foundation Year. Top 5% of the cohort.</p><p>Mathematics 1 and 2, Principles of Computing, Study Skills and ICT, English for Academic Purposes.</p></div></div>
...
<section><h2>Experience</h2><div class="cv-item"><span>2024–2026</span><div><h3>{link(url('projects',houmoon),'Houmoon Ltd.')}</h3><p>Founder. AI wellbeing app built with React Native and Firebase; about 100 internal testers. The company was dissolved in May 2026 before any public release.</p></div></div></section>
...
paths=['/','/about/','/cv/','/archive/']+[f'/{k}/' for k in SHOWN]+[url(k,v) for k in KINDS for v in items[k]]
